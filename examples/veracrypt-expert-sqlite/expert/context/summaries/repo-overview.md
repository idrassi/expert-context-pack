# VeraCrypt Expert (SQLite FTS) (placeholder summary)
...
2. Build the index:
   - `ecpctl build --skill examples/veracrypt-expert-sqlite`
3. Optionally generate richer summaries:
   - `ecpctl generate-summaries --skill examples/veracrypt-expert-sqlite`
