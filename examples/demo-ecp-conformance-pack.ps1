...
python -m ecp_poc.cli pack --skill $skill --out $zipPath
python -m ecp_poc.cli verify-pack --package $zipPath
...
python -m ecp_poc.cli query --skill $unpackedSkill "Which modules handle authentication?"
python -m ecp_poc.cli run-evals --skill $unpackedSkill --suite-id conformance
